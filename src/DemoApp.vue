<template>
  <div class="container">
    ...
    <form-select-list
      name="sampleMultiSelect"
      label="Sample Select list - group botton"
      :options="selectOptionsGroup"
      v-model="data.sampleSelectGroupBottom"
      helper="This is a sample select list field with a validation rule that it must match red"
      validation="required">
    </form-select-list>
    <form-select-list
      name="sampleMultiSelect"
      label="Sample Select list - check"
      :options="selectOptionsCheck"
      v-model="data.sampleSelectcheck"
      helper="This is a sample select list field with a validation rule that it must match red"
      validation="required">
    </form-select-list>
    <form-input
